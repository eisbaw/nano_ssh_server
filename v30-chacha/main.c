/* Nano SSH Server - v30-chacha: v29-p256 with the four ChaCha20
 * add/XOR/rotate steps sharing one loop body. P-256, SHA-256, Poly1305 and
 * the SSH protocol are unchanged. Single algorithm path, no malloc or
 * libc; fully static. See optimization_log.txt for size and test results. */

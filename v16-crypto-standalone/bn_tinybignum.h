#ifndef __BN_TINYBIGNUM_H__
#define __BN_TINYBIGNUM_H__
/*

Big number library - arithmetic on multiple-precision unsigned integers.
Based on tiny-bignum-c by kokke (public domain)
https://github.com/kokke/tiny-bignum-c

Modified for 2048-bit operations (RSA-2048 support):
- Changed from 1024-bit (128 bytes) to 2048-bit (256 bytes)
- A 2048-bit integer takes up 256 bytes RAM

The difference between this and other implementations, is that the data structure
has optimal memory utilization, and all memory is allocated statically:
no dynamic allocation for better or worse.
...
/* Size of big-numbers in bytes - configured for 2048-bit (256 bytes) */

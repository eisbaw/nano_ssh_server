/*
 * Nano SSH Server - v15-opt13
 * World's smallest SSH server for microcontrollers
 *
 * Phase 3: Conservative inline optimization
 *
 * This version applies:
 * - Static inline for tiny, frequently-called functions
 * - Maintains same functionality as v10-opt9
...
/*
 * Write uint32 in big-endian format - INLINE (very small, called frequently)
 */
static inline void write_uint32_be(uint8_t *buf, uint32_t value) {
    buf[0] = (value >> 24) & 0xFF;
    buf[1] = (value >> 16) & 0xFF;
    buf[2] = (value >> 8) & 0xFF;
    buf[3] = value & 0xFF;
...
/*
 * Write 64-bit unsigned integer in big-endian format - INLINE
 */
static inline void write_uint64_be(uint8_t *buf, uint64_t value) {
    buf[0] = (value >> 56) & 0xFF;
    buf[1] = (value >> 48) & 0xFF;
    buf[2] = (value >> 40) & 0xFF;
    buf[3] = (value >> 32) & 0xFF;
...
/*
 * Read uint32 in big-endian format - INLINE
 */

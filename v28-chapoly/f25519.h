...
#endif
extern uint8_t f25519_one[F25519_SIZE];   /* filled in by ed25519_gen() */
...
#define f25519_add(r, a, b) f25519_addsub((r), (a), (b), 0)
#define f25519_sub(r, a, b) f25519_addsub((r), (a), (b), 1)

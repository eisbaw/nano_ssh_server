...
/* Hash wrappers converted to macros */
#define compute_sha256(o,i,l) crypto_hash_sha256(o,i,l)
typedef crypto_hash_sha256_state hash_state_t;
#define hash_init(h) crypto_hash_sha256_init(h)
#define hash_update(h,d,l) crypto_hash_sha256_update(h,d,l)
#define hash_final(h,o) crypto_hash_sha256_final(h,o)

...
/*
 * Generate random bytes (using custom CSPRNG from /dev/urandom)
 ...
 * - rsa_init_key(key) - initialize hardcoded RSA key pair
 * - rsa_sign(signature, message, key) - sign SHA-256 hash with RSA
 */

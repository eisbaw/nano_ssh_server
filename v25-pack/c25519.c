...
/* Double an X-coordinate point P_m -> P_2m */
...
/* Differential addition: given P_m, P_n and P_(m-n), compute P_(m+n) */
		       ...
		       const uint8_t *x3, const uint8_t *z3)
{
	 ...
	 *   methods of factorization", page 261, sixth display, plus

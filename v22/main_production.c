 ...
 */
static size_t write_string(uint8_t *buf, const char *str, size_t str_len) {
 ...
 */
static uint8_t calculate_padding(size_t payload_len, size_t block_size) {
 ...
 */
static size_t write_name_list(uint8_t *buf, const char *names) {
